...
export default function GettingStarted() {
  ...
  const [dockerConfig, setDockerConfig] = useState({
    ...
    sftpEnabled: false,
    sftpPort: 2222,
    mountedVolume: "/home/user/.tgdcfs",
  });
            ...
            <Step>
              ...
              <StepContent>
                <Typography
                  ...
                  sx={{ marginBottom: 3 }}
                >
                  Configure the Docker settings for running TGDCFS:
                </Typography>
                ...
                >
                  <Box sx={{ display: "flex", gap: 4 }}>
                    <TextField
                      label="TGDCFS Port"
                      type="number"
                      value={dockerConfig.tgdcfsPort}
                      onChange={(e) =>
                        setDockerConfig((prev) => ({
                          ...prev,
                          tgdcfsPort: parseInt(e.target.value) || 1900,
                        }))
                      }
                    />
                    <TextField
                  ...
                  {dockerConfig.sftpEnabled && (
                    <Typography variant="body2" color="text.secondary">
                      Only needed when <code>tgdcfs.sftp.enabled</code> is set in
                ...
                >
                  <code className="text-sm text-slate-300 block break-all">
                    ...
                    :/home/tgdcfs/.tgdcfs -p {dockerConfig.tgdcfsPort}:
                    {dockerConfig.tgdcfsPort}
                    {dockerConfig.sftpEnabled
