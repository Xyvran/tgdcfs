      ...
      {config.enabled && (
        <Box sx={{ pl: 2, borderLeft: 2, borderColor: "divider" }}>
          ...
          {config.passphrase_source === "passphrase_env" && (
            <Box sx={{ mb: 2 }}>
              <ConfigTextField
                ...
                fullWidth
                required
                helperText='TGDCFS reads this env var at startup. e.g. "TGDCFS_MASTER_PASSPHRASE"'
              />
            </Box>
          )}
          ...
          {config.passphrase_source === "passphrase_file" && (
            <Box sx={{ mb: 2 }}>
              <ConfigTextField
                ...
                fullWidth
                required
                helperText="Path is relative to TGDCFS_DATA_DIR (~/.tgdcfs by default). Trailing newline is stripped."
              />
            </Box>
          )}
          ...
          <ConfigTextField
            ...
            fullWidth
            sx={{ mb: 3 }}
            helperText="Path relative to TGDCFS_DATA_DIR. Default: master.salt"
          />
          ...
          <Alert severity="info" sx={{ mt: 3 }}>
            ...
            <Box component="ul" sx={{ pl: 2, m: 0 }}>
              ...
              <li>
                ...
                file so it can be decrypted even if the TGDCFS metadata is lost.
              </li>
              <li>
