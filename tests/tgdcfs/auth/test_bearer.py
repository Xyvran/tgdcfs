...
import time
import jwt
from tgdcfs.auth.bearer import login, authenticate, JWTPayload
from tgdcfs.auth.user import AdminUser, ReadonlyUser
from tgdcfs.errors import LoginFailed
...
class TestBearerAuth:
    def test_login_anonymous_when_no_users(self, mocker):
        ...
        mock_config.tgdcfs.users = {}
        mock_config.tgdcfs.jwt.secret = "test_secret"
        mock_config.tgdcfs.jwt.algorithm = "HS256"
        mock_config.tgdcfs.jwt.life = 3600

        mocker.patch("tgdcfs.auth.bearer.config", mock_config)
        mocker.patch("tgdcfs.auth.bearer.jwt_config", mock_config.tgdcfs.jwt)
    ...
    def test_login_anonymous_disabled(self, mocker):
        ...
        mock_config = mocker.Mock()
        mock_config.tgdcfs.users = {"testuser": mock_user}
        mock_config.tgdcfs.jwt.secret = "test_secret"
        mock_config.tgdcfs.jwt.algorithm = "HS256"
        mock_config.tgdcfs.jwt.life = 3600
    ...
    def test_login_readonly_user(self, mocker):
        ...
        mock_config = mocker.Mock()
        mock_config.tgdcfs.users = {"readonly_user": mock_user}
        mock_config.tgdcfs.jwt.secret = "test_secret"
        mock_config.tgdcfs.jwt.algorithm = "HS256"
        mock_config.tgdcfs.jwt.life = 3600
