...
from tgdcfs.config import Config, TelegramConfig, BotConfig, AccountConfig
...
class TestTelethonAPI:
    ...
    async def test_download_file_success(
        ...
        req = DownloadFileReq(chat=mock_chat, message_id=54321, begin=0, end=17)
    ...
    async def test_download_file_gives_up_on_a_second_expiry(
        ...
        resp = await telethon_api.download_file(
            DownloadFileReq(chat=mock_chat, message_id=54321, begin=0, end=5)
        )
    ...
    async def test_download_file_message_without_document(
        ...
        req = DownloadFileReq(chat=mock_chat, message_id=12345, begin=0, end=99)
    ...
    async def test_download_file_invalid_range(
        ...
        req = DownloadFileReq(chat=mock_chat, message_id=54321, begin=100, end=50)
