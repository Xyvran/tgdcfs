...
from tgdcfs.core.model.file import (
    TGFSFileVersion,
    TGFSFileDesc,
    EMPTY_FILE_MESSAGE,
    INVALID_FILE_SIZE,
...
class TestTGFSFileVersion:
    ...
    @patch("tgdcfs.core.model.file.uuid")
    @patch("tgdcfs.core.model.file.datetime")
...
class TestTGFSFileDesc:
    ...
    @patch("tgdcfs.core.model.file.TGFSFileVersion.from_sent_file_message")
