...
from tgdcfs.core.model import TGFSDirectory, TGFSFileRef, TGFSFileDesc
from tgdcfs.errors import FileOrDirectoryDoesNotExist, InvalidPath
...
class TestOps:
    ...
    def mock_create_task(self, mocker):
        ...
        create_task = mocker.patch("tgdcfs.core.ops.create_upload_task")
