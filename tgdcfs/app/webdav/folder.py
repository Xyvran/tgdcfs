...
from tgdcfs.app.fs_cache import FSCache, gfc
from tgdcfs.app.utils import strip_webdav_prefix
from tgdcfs.core import Client, Ops
...
# The top level is the list of configured file systems, not a writable
# directory.
_NO_NEW_MEMBERS = "the top level only holds the configured file systems"
...
class RootFolder(_Folder):
    ...
    def _route(self, path: str) -> Tuple[Optional[Folder], str]:
        ...
        The first segment names a configured file system. A name that is not
