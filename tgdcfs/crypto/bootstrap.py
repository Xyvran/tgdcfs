"""Bootstrap helpers that wire :mod:`tgdcfs.crypto` into the runtime config.
...
from tgdcfs.config import EncryptionConfig
...
def _load_or_create_master_salt(path: str) -> bytes:
    ...
    keep it neatly grouped with other TGDCFS state.
    """
