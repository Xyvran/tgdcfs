"""Transparent at-rest encryption layer for TGDCFS.
...
Design summary:
  ...
  * File header:    60 bytes, inline at the start of the first Telegram part,
                    ...
                    TGDCFS metadata store is lost.

The encryption layer is implemented as a decorator around
``IFileContentRepository`` -- the rest of TGDCFS does not need to know whether
...
from tgdcfs.crypto.cipher import ChunkedAESGCM
from tgdcfs.crypto.header import FileHeader
from tgdcfs.crypto.kdf import derive_file_key, derive_master_key
from tgdcfs.crypto.names import decrypt_name, derive_name_key, encrypt_name
